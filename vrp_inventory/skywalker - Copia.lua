	...
	if user_id and ramount ~= nil and parseInt(ramount) >= 0 and not actived[user_id] and actived[user_id] == nil then
		if type == "usar" then
			...
			elseif itemName == "hotdog" then
				...
				----------------------------
			elseif itemName == "paoovo" then
				local src = source
				if vRP.tryGetInventoryItem(user_id,"paoovo",1) then
					actived[user_id] = true
					TriggerClientEvent('vrp_inventory:Update',source,'updateMochila')
					TriggerClientEvent("emotes",source,"comer2")
					TriggerClientEvent("progress",source,10000,"comendo")
			...
			elseif itemName == "massa" then
				local src = source
				if vRP.tryGetInventoryItem(user_id,"massa",1) then
					actived[user_id] = true
					TriggerClientEvent('vrp_inventory:Update',source,'updateMochila')
					TriggerClientEvent("emotes",source,"comer2")
					TriggerClientEvent("progress",source,10000,"comendo")
			...
			elseif itemName == "lasanha" then
				local src = source
				if vRP.tryGetInventoryItem(user_id,"lasanha",1) then
					actived[user_id] = true
					TriggerClientEvent('vrp_inventory:Update',source,'updateMochila')
					TriggerClientEvent("emotes",source,"comer2")
					TriggerClientEvent("progress",source,10000,"comendo")
			...
			elseif itemName == "hamburger" then
				local src = source
				if vRP.tryGetInventoryItem(user_id,"hamburger",1) then
					actived[user_id] = true
					TriggerClientEvent('vrp_inventory:Update',source,'updateMochila')
					TriggerClientEvent("emotes",source,"comer2")
					TriggerClientEvent("progress",source,10000,"comendo")
			...
			elseif itemName == "salada" then
				local src = source
				if vRP.tryGetInventoryItem(user_id,"salada",1) then
			...
			elseif itemName == "carneassada" then
				local src = source
				if vRP.tryGetInventoryItem(user_id,"carneassada",1) then
			...
			elseif itemName == "mistoquente" then
				local src = source
				if vRP.tryGetInventoryItem(user_id,"mistoquente",1) then
			...
			elseif itemName == "espaguete" then
				local src = source
				if vRP.tryGetInventoryItem(user_id,"espaguete",1) then
			...
			elseif itemName == "bolodecenoura" then
				local src = source
				if vRP.tryGetInventoryItem(user_id,"bolodecenoura",1) then
			...
			elseif itemName == "peixefrito" then
				local src = source
				if vRP.tryGetInventoryItem(user_id,"peixefrito",1) then
